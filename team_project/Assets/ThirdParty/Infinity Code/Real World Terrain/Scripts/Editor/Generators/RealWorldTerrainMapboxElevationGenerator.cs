...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public class RealWorldTerrainMapboxElevationGenerator : RealWorldTerrainElevationGenerator
    {
        ...
        private RealWorldTerrainMapboxElevationGenerator(int isx, int isy, int iex, int iey, int zoom)
        {
            ...
            RealWorldTerrainGeo.TileToLatLong(isx, isy, zoom, out mx1, out my1);
            RealWorldTerrainGeo.TileToLatLong(iex + 1, iey + 1, zoom, out mx2, out my2);
            RealWorldTerrainGeo.LatLongToMercat(ref mx1, ref my1);
            RealWorldTerrainGeo.LatLongToMercat(ref mx2, ref my2);
        ...
        public static void Init()
        {
            ...
            RealWorldTerrainGeo.LatLongToTile(prefs.leftLongitude, prefs.topLatitude, zoom, out stx, out sty);
            RealWorldTerrainGeo.LatLongToTile(prefs.rightLongitude, prefs.bottomLatitude, zoom, out etx, out ety);
