    ...
    private void ShowEndScreen(bool finish)
    {
        if (finishText != null)
        {
            finishText.text = finish
                ? "You completed a lap and toyed with the captor in the palm of your hand."
                : $"You have been caught by the police, and you escaped for a total of {raceTimer:F2} seconds.";
